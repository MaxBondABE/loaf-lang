...
pub mod coordinates_tests {
    ...
    fn coord_1d_offset_x_works() {
        assert_eq!(
            Coordinate1D::default()
                .offset(Dimension::X, 100)
                .collect::<Vec<_>>(),
    ...
    fn coord_3d_offset_all_works() {
        assert_eq!(
            Coordinate3D::default()
                ...
                .collect::<Vec<_>>(),
            vec!(
                Coordinate3D::new(100, 0, 0),
                Coordinate3D::new(0, 100, 0),
                Coordinate3D::new(0, 0, 100)
            )
        )
    }
